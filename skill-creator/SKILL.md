...
|----------|---------|-------------|
| SKILL.md | Instructions for the agent | skill-creator (you) |
| EVAL.md | Quality criteria + test prompts | write-skill-eval pipeline |
| templates/ | Output format skeletons (optional) | skill-creator (you) |
| references/ | Domain knowledge, loaded on demand (optional) | skill-creator (you) |
| examples/ | Complete worked examples (optional) | skill-creator (you) |
