...
**Prompt:**
```
/synapse-gatekeeper src/skill/write-scope-docs
```
...
**Prompt:**
```
/synapse-gatekeeper src/skill/skill-creator --score 84
```
...
**Prompt:**
```
/synapse-gatekeeper src/skill/write-skill-eval --score 76
```
...
**Prompt:**
```
/synapse-gatekeeper src/skill/stakeholder-reviewer
```
...
**Prompt:**
```
/synapse-gatekeeper src/skill/generate-output-criteria
```
