...
This is `src/protocols/failure-reporting/failure-reporting.md`, annotated to show why each section works. Use this as a reference when drafting new protocols.
