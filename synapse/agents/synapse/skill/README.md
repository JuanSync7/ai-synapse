...
| [synapse-skill-design-judge](synapse-skill-design-judge.md) | judge | Graded design-quality judge — scores a SKILL.md on six design-principle dimensions (1-5) and emits fix suggestions for dimensions below threshold |
