...
| [synapse-skill-signal-reviewer](synapse-skill-signal-reviewer.md) | reviewer | Thin orchestrator — dispatches anatomy/design/companion sub-agents in parallel and aggregates a unified APPROVE/REVISE/ESCALATE verdict before eval generation |
