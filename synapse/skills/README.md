...
Framework skills — the meta-tools used to build, evaluate, and govern artifacts.

| Domain | Description |
|--------|-------------|
| [agent/](agent/) | Agent definition lifecycle — create and evaluate agent recipes |
| [meta/](meta/) | Framework meta-utilities (skill routing) |
