...
> **Read [`../../../../taxonomy/SKILL_TAXONOMY.md`](../../../../taxonomy/SKILL_TAXONOMY.md)** at session start to internalize the domain and intent vocabulary. If SKILL_TAXONOMY.md is missing or unreadable, fall back to directory names as the domain vocabulary — list `<repo>/` and use directory names (`docs/`, `code/`, `meta/`, etc.) as domain hints.
