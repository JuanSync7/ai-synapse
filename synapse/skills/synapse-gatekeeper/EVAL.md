...
**Prompt:**
```
/synapse-gatekeeper src/skills/docs/write-scope-docs
```
...
**Prompt:**
```
/synapse-gatekeeper synapse/skills/synapse-creator --score 84
```
...
**Prompt:**
```
/synapse-gatekeeper synapse/skills/write-synapse-eval --score 76
```
...
**Prompt:**
```
/synapse-gatekeeper synapse/skills/stakeholder-reviewer
```
