...
```
/write-synapse-eval skill synapse/skills/improve-skill
→ Wrote synapse/skills/improve-skill/EVAL.md with 14 EVAL-S, 9 EVAL-O, 6 test prompts
```
...
```
/write-synapse-eval skill synapse/skills/synapse-gatekeeper
→ FAIL: EVAL.md exists at synapse/skills/synapse-gatekeeper/EVAL.md.
